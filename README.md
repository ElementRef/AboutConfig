### 自用 [Code 配置](https://github-public-raw.spicicomic.workers.dev/ElementRef/AboutConfig/main/conf/vscode.settings.json?raw)、[Quantumult X 配置](https://github-public-raw.spicicomic.workers.dev/ElementRef/AboutConfig/main/conf/quantumult.x.conf?raw)、[uBlocklist 规则](https://github-public-raw.spicicomic.workers.dev/ElementRef/AboutConfig/main/filter/element.ref.ublock.mixture.ini?raw) 
...
- [@NSRingo](https://github.com/NSRingo/WeatherKit)
...
- [@sooyaaabo](https://github.com/sooyaaabo/LoonLab)
